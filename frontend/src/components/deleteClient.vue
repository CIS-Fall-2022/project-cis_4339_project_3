<template>
  <main>
    <div>
      <h1 class="font-bold text-4xl text-red-700 tracking-widest text-center mt-10">Delete Client</h1>
    </div>
    ...
    <!-- Display Found Data -->
    <!-- added inline delete button to delete the selected client -->
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-10">
      <div class="ml-10">
...
export default {
  ...
  methods: {
    ...
    // added function to delete client
    deleteClient(clientID) {
      let text = "Are you sure you want to delete this client?\n\nClick OK to delete or Cancel to go back.";
      if (confirm(text) == true) {
        const apiURL = import.meta.env.VITE_ROOT_API + `/primarydata/` + clientID;
